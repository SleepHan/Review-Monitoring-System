...
class SenticGCNBasePostprocessor:
    ...
    def __init__(self, return_full_text: bool = False, return_aspects_text: bool = False, return_probabilities_before_argmax: bool = False) -> None:
        self.return_full_text = return_full_text
        self.return_aspects_text = return_aspects_text
        self.return_probabilities_before_argmax = return_probabilities_before_argmax
    ...
    def __call__(
        ...
        # Process output
        outputs = []
        if self.return_probabilities_before_argmax:
            for processed_input, prediction, probabilities in zip(processed_inputs, predictions, probabilities):
                exists = False
                ...
                for idx, proc_output in enumerate(outputs):
                    if proc_output["sentence"] == processed_input.full_text_tokens:
                        ...
                        if self.return_probabilities_before_argmax:
                            outputs[idx]["probability"].append(probabilities)
                ...
                if self.return_probabilities_before_argmax:
                    processed_dict["probability"] = [probabilities]
...
class SenticGCNBertPostprocessor(SenticGCNBasePostprocessor):
    ...
    def __init__(self, return_full_text: bool = False, return_aspects_text: bool = False, return_probabilities_before_argmax: bool = False) -> None:
        super().__init__(return_full_text=return_full_text, return_aspects_text=return_aspects_text, return_probabilities_before_argmax=return_probabilities_before_argmax)
